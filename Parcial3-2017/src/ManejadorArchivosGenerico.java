...
public class ManejadorArchivosGenerico {
    ...
    */
    ...
    /**
    * Metodo encargado de filtrar los chars de fin de linea.
    * @param unaPalabra Palabra a evaluar
    * @return Cadena de caracteres limpia
    */
    public static String filtrarEOL(String unaPalabra) {
        unaPalabra=unaPalabra.replaceAll("\n","");
        return unaPalabra.trim();
    }
}
