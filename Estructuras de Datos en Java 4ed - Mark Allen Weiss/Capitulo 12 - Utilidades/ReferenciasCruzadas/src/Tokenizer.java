...
public class Tokenizer {
    ...
    /**
     * Return an identifier read from input stream First character is already
     * read into ch
     */
     ...
     * constants. Place identifier in currentIdNode.word and return false only
     ...
     * putBackChar puts the character back onto the stream. It should only be
     * used once after a nextChar. Both routines adjust currentLine if
     * necessary.
     */
     ...
     * beginning quote. Postcondition: Stream will be set immediately after
     * matching quote
     */
    ...
    /**
     * After the opening slash is seen deal with next character. If it is a
     * comment starter, process it; otherwise putback the next character if it
     * is not a newline.
     */
