...
public class Parcial2 {
    ...
    public static void main(String[] args) throws IOException {
         ...
         *
         */
        TArbolPiezas repuesteria = new TArbolPiezas();
        ...
        for (int i = 0; i < lineas.length; i++) {
            ...
            if (productoAux[i][0] != null && productoAux[i][1] != null && productoAux[i][2] != null && productoAux[i][3] != null && productoAux[i][4] != null) {
                ...
                repuesteria.insertar(new TElementoAB<>(productoAux[i][0], nuevo));
         ...
         *
         */
        int[] cantidadYvalor = repuesteria.cantYvalorStock();
         ...
         *
         */
        Nodo<Pieza> aux3 = repuesteria.inorden().getPrimero();
         ...
         *
         */
        TArbolPiezas arbolRubro10 = repuesteria.piezasPorRubro("10");
        Lista<Pieza> lista = repuesteria.inorden();
         ...
         */
        cantidadYvalor = arbolRubro10.cantYvalorStock();
