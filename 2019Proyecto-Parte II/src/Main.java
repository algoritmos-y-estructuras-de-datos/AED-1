...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        once.cargarTeams("src/teams.csv");
        once.cargarPlayers("src/players.csv");
        once.cargarMatches("src/matches.csv");
        once.cargarMatchSt("src/match-standings.csv");
        once.cargarEvents("src/events.csv");
    ...
    public static void menu(int opcion, OnceIdeal once) {
        ...
        switch (opcion) {
            ...
            case 2:
                ...
                System.out.println("El golero mas efectivo es: " + golero.getDato().toStringGolero());
                break;
            case 3:
            ...
            case 4:
                ...
                System.out.println("El equipo mas goleador es: " + team1.getDato().name + " con " + team1.getDato().getGolesHechos(Integer.parseInt(temp)) + " goles");
                System.out.println("El equipo mas goleado es: " + team2.getDato().name + " con " + team1.getDato().getGolesRecibidos(Integer.parseInt(temp)) +  " goles recibidos");
                break;
            case 5:
