...
public class NodoTest {
    ...
    Nodo<String> nodoPrueba3;
    Nodo<String> nodoPrueba2;
    Nodo<String> nodoPrueba1;
    Nodo<String> nodoPrueba0;
    Nodo<String> nodoNulo;
    ...
    public void testGetDato() {
        assertTrue((nodoPrueba1.getDato()).equals("dato1"));
    }
    ...
    public void testSetDato() {
        ...
        assertTrue((nodoPrueba1.getDato()).equals("dato2"));
    }
